...
- (void)processingThread {
    ...
    destinationFormat.mSampleRate = [self.outputSettings[AVSampleRateKey] floatValue];
    ...
    UInt32 outputBitRate = (UInt32)[self.outputSettings[AVEncoderBitRateKey] unsignedIntegerValue];
    OSStatus err = AudioConverterSetProperty(converter, kAudioConverterEncodeBitRate, sizeof(outputBitRate), &outputBitRate);
